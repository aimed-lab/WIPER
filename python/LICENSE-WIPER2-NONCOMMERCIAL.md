...
the path-flow implementation files, and downstream SPINNER integrations that
use WIPER2.

Permission is granted, free of charge, to use, copy, modify, and distribute
WIPER2 and associated documentation files solely for non-commercial research,
education, evaluation, and academic purposes.

Commercial use is not permitted under this license. Commercial use includes,
without limitation, use of WIPER2 in or for a commercial product, service,
platform, paid consulting engagement, revenue-generating workflow, commercial
